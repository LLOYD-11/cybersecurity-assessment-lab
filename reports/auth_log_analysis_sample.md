...
| --- | --- | --- | --- | --- | --- |
| critical | `success_after_failures` | 203.0.113.10 | alice | 5 | Successful login for 'alice' after 5 failures from 203.0.113.10 within 60 minutes. |
| high | `repeated_failed_logins` | 203.0.113.10 | - | 5 | 5 failed login attempts from 203.0.113.10 within 60 minutes. |
